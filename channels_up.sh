...
PEERS_CH1=( 'peer0' 'peer1' 'peer2' )
PEERS_CH2=( 'peer0' 'peer2' 'peer3' )
for peer in {0..2} ; do
...
docker exec -it peer1 sh -c "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/fabric/admin/ && peer channel update -o 145.94.222.154:7050 -c ch1 -f ./art/Org1MSPanchors1.tx" 
docker exec -it peer2 sh -c "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/fabric/admin/ && peer channel update -o 145.94.222.154:7050 -c ch1 -f ./art/Org2MSPanchors1.tx" 
docker exec -it peer2 sh -c "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/fabric/admin/ && peer channel update -o 145.94.222.154:7050 -c ch2 -f ./art/Org2MSPanchors2.tx"
docker exec -it peer3 sh -c "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/fabric/admin/ && peer channel update -o 145.94.222.154:7050 -c ch2 -f ./art/Org3MSPanchors2.tx"   
